...
class RaceConditionValidator(Validator):
    ...
    def plan(self, finding: Finding, exchange: HttpExchange) -> Any:
        ...
        plan_id = f"race_test_{hashlib.sha256(plan_data.encode()).hexdigest()[:16]}"
        ...
        return TestPlan(
            ...
            description=f"Race condition validation for {finding.vulnerability_class}",
            parameters={
            ...
            expected_outcome=f"Fire {self.burst_size} concurrent copies of this request and count clean successes",
