...
class ExchangeCache:
    ...
    @staticmethod
    def compute_exchange_hash(exchange: HttpExchange) -> str:
        """
        ...
        req_headers = sorted(exchange.request_headers.items())
        resp_headers = sorted(exchange.response_headers.items())
