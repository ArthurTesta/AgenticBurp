...
**STOP — a much more current handover exists: `HANDOVER_LATEST.md`.** This
file reviews one earlier session's work only and predates severe bugs found
and fixed later, plus real live-target testing. Historical context only.
