...
**STOP — this file is superseded. Read `HANDOVER_LATEST.md` first.** A later
session fixed severe bugs this document doesn't know about (the entire
specialist-agent pipeline was non-functional until that session) and ran
real live-target testing. Kept for historical "why," not current "what exists now."
