...
// Assertions.java (assertTrue/assertFalse/assertEquals/assertNotEquals/
// assertNull with boolean/Object + String message overloads).
public class Assertions {
    ...
    public static void assertNotEquals(Object unexpected, Object actual) { assertNotEquals(unexpected, actual, (String) null); }
    public static void assertNotEquals(Object unexpected, Object actual, String message) {
        boolean eq = (unexpected == null) ? (actual == null) : unexpected.equals(actual);
        if (eq) throw new AssertionError((message == null ? "" : message + " -- ") + "expected values to differ but both were <" + actual + ">");
    }
