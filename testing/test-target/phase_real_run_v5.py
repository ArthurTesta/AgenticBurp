...
import store
store._DB_PATH = "/tmp/pixelmart_real_state_v5.db"
import cache
cache.init_cache(db_path="/tmp/pixelmart_real_cache_v5.db")
...
async def main():
    ...
    with open("/tmp/pixelmart_real_results_v5.json", "w") as f:
    ...
    print(f"Full results -> /tmp/pixelmart_real_results_v5.json")
